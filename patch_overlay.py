import sys
content = open("app/src/main/java/com/example/service/OverlayManager.kt").read()

new_overlay = """package com.example.service
...
with open("app/src/main/java/com/example/service/OverlayManager.kt", "w") as f:
    f.write(new_overlay)
